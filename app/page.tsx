...
import { User, Phone, ChevronRight, X, CheckCircle2, Star, ShieldCheck, Sparkles } from 'lucide-react';
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 0 && (
          ...
          >
            ...
            >
              <span className="text-white text-4xl font-serif italic font-bold">L</span>
            </motion.div>

            {/* 피드백 반영: 한 줄 설명 추가 */}
            <p className="text-[#D4A373] font-bold tracking-[0.2em] text-[10px] mb-2 uppercase">Relájate y renueva tu energía</p>
            <h1 className="text-5xl font-bold tracking-tighter mb-2 italic font-serif text-[#2C2C2C]">LUBA SPA</h1>
            <p className="text-gray-400 font-light text-sm mb-8">Experiencia de bienestar en CDMX</p>
            ...
            <div className="flex flex-col gap-2 mb-10 items-center">
                ...
                <span className="text-[11px] font-bold text-gray-600 uppercase tracking-tighter">Ambiente relajante y seguro</span>
                </div>
                <div className="flex items-center gap-1.5 text-gray-400">
                    <Sparkles size={12} />
                    <span className="text-[10px] uppercase tracking-widest font-medium">Atención profesional</span>
                </div>
            </div>
        ...
        {step === 1 && (
          ...
          >
            <div className="p-6 border-b flex justify-between items-center bg-white">
              <h2 className="text-xl font-bold font-serif italic tracking-tight text-[#2C2C2C]">Seleccionar Fecha</h2>
        ...
        {step === 2 && (
          ...
          >
            ...
            {/* 피드백 반영: 빠른 예약 강조 문구 */}
            <div className="bg-gray-50 p-4 rounded-2xl mb-8 border border-gray-100 text-center">
                <p className="text-[#D4A373] text-sm font-bold italic">Reserva en menos de 1 minuto</p>
            </div>
        ...
        {step === 3 && (
          ...
          >
            ...
            <button onClick={() => setStep(0)} className="text-[#D4A373] font-bold border-b-2 border-[#D4A373] pb-1 uppercase text-[10px] tracking-widest">
              Volver al inicio
            </button>
          </motion.div>
        )}
